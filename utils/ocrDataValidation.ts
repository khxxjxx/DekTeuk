...
const txtDataToJoin =
  '사업자등록증(법인사업자)등록번호 :13083505법인명(단체명):주식회사창세환경대표천창봉개업        년2001년12월01일법인등록번호:134911-0020965사업장소재지:경기도광명시하안로108.719(소하동에이스굉명타워)본점소재지:경기도광명시하안로108719(소하동에이스공명타워)S사업의 종류:업태서비스종목청소업저수조청소소독업도소매청소용품통신판매소독약품건물관리업건물관리업H10NANTS교부사유:사업장이전국세청KOREA사업자단위과세적용사업자여부:여()부(V)2012년03 월13 일시 흥세무서장단위는(인)NTS국세청';
